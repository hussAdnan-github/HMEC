...
export default async function CMSPublicServicesPage() {
  const publicServices = await getPublicServicesServerAction() || [];
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      {/* Public Services Manager Component */}
      <PublicServicesTab initialPublicServices={publicServices} />
    </div>
  );
}
